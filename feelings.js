...
(function () {
    ...
    const data = [
        ...
        ['RCDP Procedure', 'Interruptions and Pauses', "I liked the pauses and I think the instructors today were amazing and I liked the pauses and I liked the feedback and the starting over.", "plus"],
        ['RCDP Procedure', 'Interruptions and Pauses', "It was very positive the stop and go was great it like helps to fine tune things that maybe you don't you know wouldn't be seen or addressed like if even if  the instructor. If they notice you're doing something but in the immersive one it's by the end they're not going to remember or they're thinking of something else so that's not addressed. So I think it's cool how they stop and go like they can immediately be addressed.", "plus"],
        ['RCDP Procedure', 'Interruptions and Pauses', "I think it was effective because it was such frequent pausing to say you did all of these things right. And it really like such a positive reinforcement that I found it very helpful.", "plus"],
        ['RCDP Procedure', 'Interruptions and Pauses', "I will say that it was informative when she the stop and pause and the stop and pause and go made us really aware of what we was doing and it allowed us to actually to get in sync with each other.", "plus"],
        ['RCDP Procedure', 'Interruptions and Pauses', "I think at first it was it was an adjustment. You know just change your momentum and thoughts and everything are going so it’s hard to just be like errr stop and listen and start over.", "plus"],
        ['RCDP Procedure', 'Interruptions and Pauses', "I've already got in mind what I need to accomplish. I set about doing it you get in that mindset and you get stopped it is aggravating. Because I have got stuff I need to do.", "pencil"],
        ['RCDP Procedure', 'Interruptions and Pauses', "To me the breaks in it cause you to break concentration. I don’t know that the breaks were beneficial to be quite honest, ", "pencil"],
        ['RCDP Procedure', 'Interruptions and Pauses', "To me this is interrupting that muscle memory. I'm losing my concentration.", "pencil"],
        ['RCDP Procedure', 'Interruptions and Pauses', "There is something about pausing that almost stopped us from problem solving. Because the solution was just given to us that was this was your problem. This is how you would fix it. Instead of us actually going and actually figuring it out on our own.", "pencil"],
        ['RCDP Procedure', 'Interruptions and Pauses', "I think that by stopping that was that we did it stops the scenario from developing because we would probably have covered those things on into the scenario as it developed.", "pencil"],
        ['RCDP Behavioral', 'Emotions', "I kind of like pausing and then when you kind of talk about it kind of takes away [stress] what all it kind of relieves you and you are like ok that makes sense and then you do it right way. It kind of gives you a little bit of motivation. And then you pause again it kind of it just helped me to not be so stressed out about it. Not trying to worry about getting through the scenario and not messing up.", "plus"],
        ...
        ['RCDP Behavioral', 'Emotions', "They are really stopping you and breaking it down and you know exactly like she said everybody has a role you know exactly what you are supposed to do. I just felt more comfortable.", "plus"],
        ['RCDP Behavioral', 'Emotions', "For some reason that felt more stressful to me than the other sims.", "pencil"],
        ['RCDP Behavioral', 'Emotions', "At first when it first started I was intimidated. Just because I have not worked with anybody here.", "pencil"],
        ['RCDP Behavioral', 'Emotions', "First reaction to it is one of frustration because your natural inclination when simulating a real life critical care event is to move rapidly and to be very assertive and I think that when you're in the middle of assertive task and someone asks you to hold that task your initial response is frustration.", "pencil"],
        ['RCDP Behavioral', 'Emotions', "At first I found it kind of aggravating.", "pencil"],
        ['RCDP Behavioral', 'Emotions', "It was frustrating.", "pencil"],
    ...
    $main.append($('<p>', {html: '<div class="text-muted">Kelly Roszczynialski MD, MS*, Shilpa Register PhD, OD, Lisa Bergman RN, and Marjorie Lee White MD, MA, MPPM<p><small>*Corresponding Author (<a href=mailto:knroszcz@stanford.edu>knroszcz@stanford.edu</a>)</small></p>'}));
    ...
    $main.append($('<h3>', {text: "Feedback", style: "margin-bottom: -32px;"}));
