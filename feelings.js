...
(function () {
    ...
    const data = [
        ['RCDP Procedure', 'Ability to adjust and analyze actions from real-time feedback', '<p><img src="images/one.png" style="max-width:1000px; width:85%;="></p>I liked the real time feedback. Being able to say stop and Give us the tip about the back board and all that. I love that.', undefined],
